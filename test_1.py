...
# Должен получиться декоратор, который записывает в
# файл 'main.log' дату и время вызова функции, имя функции,
...
def logger(old_function):
    def new_function(*args, **kwargs):
        ...
        with open('main.log', 'a') as log_file:
            log_file.write(f"{new_function.__name__} {args} {kwargs} -> {result}\n")
        return result
    return new_function
